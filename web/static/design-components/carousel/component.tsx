...
ui.Less.renderByRequireJS(pathContact(common.path, "carousel/component.less"), { contextName });
...
export class Carousel extends React.Component<Props, State> {
    ...
    createCarousel() {
        ...
        //     autoplay = false
        // }
        let c = new CarouselClass(this.element, { autoplay });
        return c;
    }
    componentDidMount() {
        //=======================================================
    ...
    render() {
        ...
        return items.length > 1 ?
            <div style={{ minHeight: '80px' }} className="carousel slide"
                ref={(e: HTMLElement) => {
                ...
                <div className="carousel-inner">
                    {items.map((o, i) =>
                        <div key={i} className={i == 0 ? "item active" : "item"}>
                            <img src={this.imageService.imageSource(o.image)} className="img-responsive"
            ...
            items.length > 0 ?
                <div ref={() => this.element = null}>
                    <img style={{ width: '100%' }} src={this.imageService.imageSource(items[0].image)}
                        ref={(e: HTMLImageElement) => e ? ui.renderImage(e) : null} />
                </div>
                :
                <div ref={() => this.element = null}>
