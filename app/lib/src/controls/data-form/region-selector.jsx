...
class RegionSelector extends taro_1.default.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return <components_1.View>
            <components_1.Picker mode="multiSelector" value={[]} range={[provinces, cities, counties]} rangeKey="Name" ref={e => this.picker = this.picker || e} onColumnChange={e => {
            ...
            this.onPickerChanged(value[2] || 0);
                ...
                <taro_ui_1.AtInput title={this.props.title} placeholder={this.props.placeholder} name={this.props.dataField} required={hasRequired} error={errorMessage != undefined} value={currentRegion ? `${currentRegion.province.Name} ${currentRegion.city.Name} ${currentRegion.county.Name}` : ""} onErrorClick={() => {
...
//# sourceMappingURL=region-selector.jsx.map